...
/**
 * Altered by https://github.com/EMREXEU in 2015
 * Alterations do not are not substantiative enough 
 * to warrant changes in copyright claim or license.
 */
...
public class DataUri {
	...
	public static DataUri parse(String uri, Charset charset) {
		...
		final byte[] finalData = "base64".equalsIgnoreCase(contentEncoding)
			? decoder.decode(data) : data.getBytes(charset);
